...
enum class ExpenseFrequency(val id: Int, val everyXMonth: Int, val multiplier: Int, val title: StringResource) {
    ...
    Quarterly(id = 1, everyXMonth = 3, multiplier = 4, title = Res.string.quarterly),
    Biannually(id = 2, everyXMonth = 6, multiplier = 2, title = Res.string.biannually),
    Annually(id = 3, everyXMonth = 12, multiplier = 1, title = Res.string.annually);
